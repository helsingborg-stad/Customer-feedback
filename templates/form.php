<div class="box box-index gutter">
    ...
    <div class="grid">
        ...
        <div class="grid-md-5 text-left-xs text-left-sm text-right-md text-right-lg">
            <div id="customer-feedback-chat-answers">
                <button class="btn btn-success" value="yes" data-action="customer-feedback-chat-submit-response"><?php _e('Yes'); ?></button>
                <button class="btn btn-error" value="no" data-action="customer-feedback-chat-submit-response"><?php _e('No'); ?></a>
            </div>
            <div id="customer-feedback-chat-comment" class="text-left" style="display: none;">
                ...
                <button style="margin-top:5px;" class="btn btn-submit" data-action="customer-feedback-chat-submit-comment">Skicka</button>
            </div>
